...
@Configuration
@PropertySource("classpath:mondb.properties")
public class MongoConfig {
    ...
    public MongoClient mongoClient() {
        ...
        build.connectionsPerHost(Integer.valueOf(maxConnect));  //连接数量
        build.threadsAllowedToBlockForConnectionMultiplier(Integer.valueOf(maxWaitThread));  // 等待队列长度 
