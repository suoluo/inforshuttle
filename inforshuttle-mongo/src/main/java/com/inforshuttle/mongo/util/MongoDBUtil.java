 ...
 * 
 * @author zhaoam
 * @date 2017-6-29 上午11:49:49
 * @version 0.0.1
 * @Copyright (c)1997-2017 NavInfo Co.Ltd. All Rights Reserved.
 */
public enum MongoDBUtil {
    ...
    public static void main(String[] args) {
       ...
       // 根据ID查询
		String id = "594fbc23ed5f9a218089988f";
        ...
        // 删除数据库
		// MongoDBUtil.instance.dropDB("GC_MAP_DISPLAY_DB1");

        // 删除表
        // MongoDBUtil2.instance.dropCollection(dbName, collName);

        // 修改数据
		String id2 = "594fbc23ed5f9a2180899890";
		Document newdoc = new Document();
		newdoc.put("name", "时候");
		MongoDBUtil.instance.updateById(coll, id2, newdoc);
        ...
        MongoCursor<Document> find = MongoDBUtil.instance.find(coll, filter);
        while(find.hasNext())
